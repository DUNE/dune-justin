...
('WORKFLOW_FAILED_TOO_MANY_FILES',
 109,
 'Workflow failed, too many input files'),
...
('JOB_ABORT_RUCIO_CLIENT',
 315,
 'Failed to initialise Rucio client'),
...
('JOB_ABORT_METADATA_CHECK',
 319,
 'Job aborted when checking JSON format'),
('JOB_ABORT_RUCIO_UPLOAD_FILE',
 320,
 'NOT USED - no longer an abort'),
('JOB_ABORT_METACAT_UPLOADED',
 321,
 'NOT USED - not done in job'),
('JOB_ABORT_CONFIRM_RESULTS',
 322,
 'Job aborted while confirming outputting results'),
