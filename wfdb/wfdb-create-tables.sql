...
CREATE TABLE `files` (
  ...
  `state` enum('finding_replicas','unallocated','allocated','processed') NOT NULL DEFAULT 'finding_replicas',
...
CREATE TABLE `requests` (
  ...
  `state` enum('draft','submitted','approved','finding_files','running','paused','checking','completed','deleted') NOT NULL,
